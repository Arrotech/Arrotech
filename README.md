...
<br>🔸 FrontEnd - React.js, React-Native, Vue.js, AngularJS, HTML, CSS
<br>🔸 BackEnd - Python, Node, .NET(C#, Visual Basic), Java
<br>🔸 Devops - AWS, Microsoft Azure, Git & GitHub, Travis CI, CircleCI, CodeCov, Coveralls, Code Climate, Nginx Docker, Pivota Tracker, and MLOPS
<p>
